...
//TODO: Injection with spring for ApplicationInterface
/**
 * Implementation of the Action Interface. 
 * In this case the DeleteAction deletes all files for an existing Application resource.
 * 
 * @see Action
 * @author Sami Yangui
 */
public class DeleteAction extends Action {
	...
	public void execute(URI uri, Method method) {
		LOGGER.debug("libvirt: Delete Application");
		...
		applicationInterface.deleteApplication(application);
