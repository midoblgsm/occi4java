 ...
 * In this case the UpdateAction creates a new definition for an Application resource.
 * 
 * @see Action
 * @author Sami Yangui
 */
public class UpdateAction extends Action {
	...
	public void execute(URI uri, Method method) {
		LOGGER.debug("libvirt: Update Application");
		...
		applicationInterface.updateApplication(application);
