...
public class StartAction extends Action {
	...
	public void execute(URI uri, Method method) {
		LOGGER.debug("libvirt: Start Container");
		...
		AutonomicManagerInterface containerInterface=new AutonomicManagerInterfaceImpl();
		containerInterface.startAutonomicManager(autonomicManager);
